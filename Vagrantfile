...
Vagrant::Config.run do |config|
  ...
  config.vm.share_folder "v-data", "/mnt/provision", "provision"
  ...
  config.vm.provision :puppet, :module_path => "modules", :options => "--verbose --debug --templatedir /tmp/vagrant-puppet/templates" do |puppet|
